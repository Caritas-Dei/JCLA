 ...
 * @author link
 */
public final class RuntimeInvisibleAnnotations extends AttributeInfo {

	private final Annotation[] annotations;

	public RuntimeInvisibleAnnotations(DataInput in, ConstantPool owner) throws IOException {
		super(in, owner);
	...
	public RuntimeInvisibleAnnotations(int nameIndex, int length, DataInput in, ConstantPool owner) throws IOException {
	...
	public RuntimeInvisibleAnnotations(int nameIndex, int length, Annotation[] annotations, ConstantPool owner) {
		super(nameIndex, length, owner);
