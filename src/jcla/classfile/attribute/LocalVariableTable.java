...
public final class LocalVariableTable extends AttributeInfo {
	...
	public LocalVariableTable(DataInput in, ConstantPool owner) throws IOException {
		super(in, owner);
	...
	public LocalVariableTable(int nameIndex, int length, DataInput in, ConstantPool owner) throws IOException {
	...
	public LocalVariableTable(int nameIndex, int length, Entry[] entries, ConstantPool owner) {
		super(nameIndex, length, owner);
	...
	public final class Entry {
		...
		public Entry(int startPC, int length, int nameIndex, int descriptorIndex, int index) {
			this.startPC = startPC;
			this.length = length;
			this.name = nameIndex;
			this.descriptor = descriptorIndex;
			this.index = index;
		}
		...
		public byte[] toBytes() {
			...
			System.arraycopy(Data.toBytesShort(descriptor), 0, bytes, 6, 2);
